...
import type { CertificateRecord as _CertificateRecord, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCertificates(): Promise<Array<CertificateRecord>> {
        if (this.processError) {
            try {
    ...
    async getCertificate(arg0: bigint): Promise<CertificateRecord | null> {
        if (this.processError) {
            try {
    ...
    async uploadCertificate(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadCertificate(arg0, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_CertificateRecord_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CertificateRecord): Promise<CertificateRecord> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CertificateRecord]): Promise<CertificateRecord | null> {
    return value.length === 0 ? null : await from_candid_CertificateRecord_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CertificateRecord>): Promise<Array<CertificateRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CertificateRecord_n11(_uploadFile, _downloadFile, x)));
}
